...
export function getTileJSON(_x) {
  return _getTileJSON.apply(this, arguments);
}

function _getTileJSON() {
  _getTileJSON = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(_ref) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.t0 = getMapsVersion(creds);
...
function _request() {
  _request = _asyncToGenerator(_regeneratorRuntime.mark(function _callee2(_ref2) {
...
function dealWithError(_ref3) {
  ...
  switch (response.status) {
    ...
    default:
      var e = getMapsVersion() === 'v1' ? JSON.stringify(json.errors) : json.error;
      throw new Error(e);
  }
}
